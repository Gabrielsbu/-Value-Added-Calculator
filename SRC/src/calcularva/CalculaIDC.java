 ...
 * @author gabrielsbu
 */
public class CalculaIDC extends javax.swing.JInternalFrame {
    
    double valorA, custoR, resultado;
            
    /**
     * Creates new form CalculaIDC
     */
    public CalculaIDC() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Indíce de Desempenho de Custo");

        painel.setBackground(new java.awt.Color(181, 173, 162));

        jLabel1.setFont(new java.awt.Font("Ubuntu", 1, 18)); // NOI18N
        jLabel1.setText("Indíce de Desempenho do Prazo (IDC)");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
       valorA = Double.parseDouble(va.getText());
        ...
        JOptionPane.showMessageDialog(null, "Excesso de custo para o trabalho executado.");
        
        }else{
            res.setText(String.valueOf(resultado));
            JOptionPane.showMessageDialog(null, "Custo abaixo do limite até a data presente.");
